...
class Triangulation
  ...
  def divide_chains(array)
    0.upto((array.length)-1) do |i|
      if i == array.length-1 && array[0].x > array[i].x
        array[i].chain = 1
  ...
  def triangulate(vertices)
    ...
    2.upto((vertices.length)-2) do |i|
      ...
      if vertices[i].chain != heap[-1].chain
        ...
        last = heap.pop
        while orientation == diagonal_orientation && heap != [] do
...
EDGES = [ [5,3], [7,1], [6,1.5], [4,1], [1,2], [2.5,2.5], [3,3] ]
EDGES1 = [ [11,0], [17,2], [21,6], [24,10], [22,14], [18,18], [12,20], [6,18], [2,14], [0,10], [1,6], [5,2] ]
EDGES2 = [ [1,0], [2,4], [3,1], [4,1], [5,4], [6,1], [7,1], [8,4], [9,1], [10,1], [11,4], [12,1], [13,1], [14,4], [15,0] ]
EDGES3 = [ [0,0], [26,0], [24,24], [23,21], [22,16], [19,13], [18,10], [15,9], [14,6], [11,5], [8,2], [4,2] ]
